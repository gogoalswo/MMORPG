...
| [items.md](items.md) | 아이템 42종(등급 7 × 슬롯 6), 등급, **랜덤 옵션(1차 드랍 · 2차 크리스탈 · 3차 비움)**, **강화 팝업(한 개 · 같은 아이템 · 같은 등급, 목표 자동 강화)**, 드롭 |
...
| [skills.md](skills.md) | 스킬 26종(격투가 6개 — 할퀴기·낙뢰·천붕각·**빙주각**에 이펙트), 스킬창, 액션바 4칸, 자동 시전, **테스트 스위치(쿨타임·레벨 잠금 해제)** |
