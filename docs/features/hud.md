...
체력 막대 · 퀵슬롯 4칸 + 자동사냥 칸)과 **오른쪽 위 메뉴**(스킬·강화·가방·던전·설계)다.
던전 단추는 2026-09-23 에 가방 오른쪽 옆에 더했다 → [dungeons.md](dungeons.md).
강화 단추는 2026-09-24 에 가방 **왼쪽** 옆에 더했다 (오른쪽 옆은 던전 자리) — 강화 창을
대상 없이 연다 → [items.md](items.md) "강화". 그림(`ui_icon_enhance`)이 아직 없어 글자로 나온다.
